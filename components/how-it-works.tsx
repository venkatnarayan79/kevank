  ...
  return (
    <section aria-label="How it works" className="py-24 bg-white">
      ...
      <div className="mt-14 grid gap-8 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 max-w-5xl mx-auto">
        ...
        <div
          onClick={scrollToTop}
          className="cursor-pointer flex flex-col items-center text-center rounded-lg border border-[#8FD0A8] p-8 hover:shadow-lg transition"
        >
        ...
        <Link
          href="/create-listing"
          className="flex flex-col items-center text-center rounded-lg border border-[#8FD0A8] p-8 hover:shadow-lg transition"
        >
          <CalendarClock
            className="h-12 w-12 stroke-[#8FD0A8]"
            aria-hidden="true"
          />
          <h3 className="mt-4 text-lg font-semibold text-gray-900">
            Book Your Rental
