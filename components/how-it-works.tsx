...
const HowItWorks: React.FC = () => {
  return (
<section aria-label="How it works" className="py-24 bg-white/90 dark:bg-black">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white text-center">How It Works</h2>
      <p className="mt-2 text-center max-w-xl mx-auto text-gray-600 dark:text-gray-300">
      ...
      <div className="mt-14 grid gap-8 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 max-w-5xl mx-auto">
        <div className="flex flex-col items-center text-center rounded-lg border border-[#8FD0A8] p-8 hover:shadow-lg transition">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Find What You Need</h3>
        ...
        <div className="flex flex-col items-center text-center rounded-lg border border-[#8FD0A8] p-8 hover:shadow-lg transition">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Book Your Rental</h3>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div className="flex flex-col items-center text-center rounded-lg border border-[#8FD0A8] p-8 hover:shadow-lg transition">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Save Money</h3>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
