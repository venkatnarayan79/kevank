...
const HowItWorks: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl sm:text-3xl font-bold text-[#0C0E1C] text-center">
        How It Works
      </h2>
      <p className="mt-4 text-center max-w-lg mx-auto text-[#0C0E1C]">
      ...
      <div className="mt-10 grid gap-y-8 gap-x-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 max-w-5xl mx-auto">
        ...
        >
          <Search
            className="h-10 w-10 sm:h-12 sm:w-12 stroke-[#0C0E1C]"
            aria-hidden="true"
          />
          <h3 className="mt-4 text-base sm:text-lg font-semibold text-[#0C0E1C]">
            Find What You Need
          </h3>
          <p className="mt-2 text-sm text-[#0C0E1C]">
