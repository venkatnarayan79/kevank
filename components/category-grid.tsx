...
const categories = [
  ...
  { name: "Kitchen / Bath", alt: "Kitchen and Bath", imageSrc: "/base.png" },
  { name: "Accessories", alt: "Accessories", imageSrc: "/bicycle.png" },
...
const CategoryGrid: React.FC = () => {
  ...
  return (
    <section aria-label="Product categories" className="w-full py-12 md:py-20 bg-white">
