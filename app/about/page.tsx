            ...
            <div className="bg-background rounded-lg shadow-lg overflow-hidden">
              <div className="p-8">
                ...
                <div className="space-y-4">
                  <p>
                    Kavenk was founded in 2023 with a simple idea: most people have equipment and tools they rarely use,
                    while others need these items but don't want to purchase them for occasional use.
                  </p>
                  <p>
                    Our founder, Alex, experienced this firsthand when moving into a new home. Needing power tools for
                    just a few days of work, Alex faced the choice of buying expensive equipment or struggling without
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-background rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-sm">
                    Former product manager with a passion for sustainable living and community building.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-sm">
                    Tech innovator with experience building marketplace platforms and secure payment systems.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4 text-center">
                  <h3 className="text-lg font-semibold">Marcus Williams</h3>
                  <p className="text-muted-foreground mb-2">Head of Community</p>
                  <p className="text-sm">
                    Community organizer focused on creating meaningful connections between users.
                  </p>
                </div>
              </div>
            </div>
